...
@implementation newsFeedStoreAddPhotosCell
...
//    self.strainRatingView.value = tempEvent.objectRating;
...
//        
//    if ([objectsArray.eventObjectArray indexOfObject:activity.activity] != NSNotFound) {

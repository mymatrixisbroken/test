...
#import "UserProfileRecentActivityTableViewController.h"

@interface UserProfileRecentActivityTableViewController ()

@end

@implementation UserProfileRecentActivityTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    NSString *cellIdentifier = @"UserProfileReviewCell";

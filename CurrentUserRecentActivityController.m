...
#import "CurrentUserRecentActivityController.h"

@interface CurrentUserRecentActivityController ()

@end

@implementation CurrentUserRecentActivityController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CurrentUserRecentActivityCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier forIndexPath:indexPath];

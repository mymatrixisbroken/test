 ...
 */
typedef NS_ENUM (NSUInteger, imageCollectionViewLayoutItemRenderDirection) {
    imageCollectionViewLayoutItemRenderDirectionShortestFirst,
    imageCollectionViewLayoutItemRenderDirectionLeftToRight,
    imageCollectionViewLayoutItemRenderDirectionRightToLeft
};
...
extern NSString *const imageCollectionViewElementKindSectionHeader;
/// A supplementary view that identifies the footer for a given section.
extern NSString *const imageCollectionViewElementKindSectionFooter;

#pragma mark - imageCollectionViewDelegateLayout

@class imageCollectionViewLayout;
 ...
 */
@protocol imageCollectionViewDelegateLayout <UICollectionViewDelegate>
@required
/**
 ...
 */
@property (nonatomic, assign) imageCollectionViewLayoutItemRenderDirection itemRenderDirection;
